...
$enseignant = $e->getEnseignantById($_GET['id'])->fetch();

//update
if(isset($_POST['edit_enseignant'])){
    $e->updateEnseignant($_POST);
                          ...
                          <div class="col-sm-12">
                            <form>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nom" value="<?php echo $enseignant['nom'] ?>" name="nom" placeholder="Entrer nom">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Prénom</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nom" value="<?php echo $enseignant['prenom'] ?>" name="prenom" placeholder="Entrer prenom">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nom" value="<?php echo $enseignant['email'] ?>" name="email" placeholder="Entrer email">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-2 col-form-label">dep</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="nom" value="<?php echo $enseignant['id_departement'] ?>" name="id_departement" placeholder="Entrer id_departement">
                                </div>
                              </div>
                              <button class="btn btn-primary btn-sm btn-round" type="submit" name="edit_enseignant">Update</button>
                            </form>
                          </div>
                        </div>
                      </div>
