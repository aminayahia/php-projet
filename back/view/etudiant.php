...
$listeEtudiant = $e->listeEtudiant();

if (isset($_GET["id"])) {
    $e->deleteEtudiant($_GET["id"]);
                       ...
                       <ul class="nav-right">
                           <li class="header-notification">
                               ...
                               <ul class="show-notification">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="../assets/images/avatar-2.jpg" alt="Generic placeholderwwww image">
                                           <div class="media-body">
                                               <h5 class="notification-user"><?php echo $etudiant[
                                                   "nom"
                                               ]; ?> <?php echo $etudiant[
     "prenom"
 ]; ?></h5>
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="../assets/images/avatar-4.jpg" alt="Generic placeholder bbbbimage">
                                           <div class="media-body">
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                      <div class="row">
                                         ...
                                         <a class="btn btn-primary btn-sm btn-round" href="addEtudiant.php">Add Etudiant</a>
                                                           ...
                                                           <div class="tab-pane active" id="home3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
																		...
																		<?php while ($el = $listeEtudiant->fetch()) { ?>
																		<tr>
																		<td><?php echo $el["id"]; ?></td>
																			<td><?php echo $el["genre"]; ?></td>
