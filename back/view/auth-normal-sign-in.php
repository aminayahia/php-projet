                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            ...
                            <div class="auth-box">
                                ...
                                <hr/>
                                <div class="row text-center f-w-600 text-inverse" >
                                    <div class="col-md-12">ou</div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"><a href="auth-sign-up.php">Sign up now</a></button>
                                    </div>
                                </div>
                            </div>
                        </form>
