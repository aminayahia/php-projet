                            ...
                            <form method="post">
                              ...
                              <div class="col-sm-12">
                                <select name="class" class="form-control">
                                  ...
                                  <option value="**">Select Departement</option> <?php
											while($dep = $listeD->fetch()){
												?> <option value="
																																				<?php echo $dep['id_departement']?>"> <?php echo $dep['titre']?> </option> <?php } ?>
                                </select>
                              </div>
                              <button type="submit" name="add_enseignant" class="btn btn-primary btn-sm btn-round" type="submit">add enseignant</button>
                            </form>
                          </div>
                        </div>
                      </div>
